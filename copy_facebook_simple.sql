...
-- Simple approach: copy data as-is, skip problematic rows
-- ============================================================================

-- Copy fb_ads_campaign (no issues)
...
-- Copy fb_ads_ad_set (skip rows where end_time cannot be cast)
...
-- Copy fb_ads_insight_actions (skip rows where value is NULL)
...
-- Copy fb_ads_audience_adset (no issues)
...
-- Copy fb_ads_custom_conversion (no issues)
